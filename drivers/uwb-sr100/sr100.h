...
#define SR100_SET_FWD _IOW(SR100_MAGIC, 0x02, uint32_t)
#define SR100_ESE_RESET _IOW(SR100_MAGIC, 0x03, uint32_t)
#define SR100_GET_THROUGHPUT _IOW(SR100_MAGIC, 0x04, uint32_t)
